...
<th class="bot"> <input type="button"  name="up" id="up" value="Modificar"></th> -->
    ...
    <div class="mostrar">
        ...
        echo '<h2 align="center">Lista de Productos</h2>';
        echo '<form  action="../../business/productoaccion/ProductoAccion.php" method="Post" align="center" id="mostrar">';
        echo'<table>';
        echo '<thead>';
        echo '<tr>';
        ...
        echo '</table>';
        echo '</form>';
        echo '<h2 align="center">Buscar Producto</h2>';
