   ...
   include '../../business/ventaaccion/pro.php';
    ...
    if(isset($_SESSION["carrito"])){
        ...
        foreach ($carrito as $p) {
            ...
            echo "<td>";
            echo "<a href='../../business/ventaaccion/ventaAccion.php?eliminar=$i'>Eliminar</a>";
            echo "</td>";
            $total +=$p->subtotal;
            $i++;
            echo "</tr>";
        ...
        echo "<tr>";
        echo "<td colspan='3'>";
        echo "<a href='../../business/ventaaccion/ventaAccion.php'>Procesar</a>";
        echo "</td>";
        echo "<td colspan='3'>";
        echo "<a href='../../business/ventaaccion/ventaAccion.php'>Cancelar</a>";
        echo "</td>";
        echo "</tr>";
        echo "</table>";
