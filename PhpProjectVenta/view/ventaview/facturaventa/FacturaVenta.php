...
<body>
    ...
    <form  action="FacturaVenta.php" method="Post">
        <table>
            <thead>
                    <tr>
                    <th></th>
            ...
            <td><a href="?action=editar&id=<?php echo $current['facturaid']; ?> ">Modificar</a></td>
            <td><a href="?action=eliminar&id=<?php echo $current['facturaid']; ?> ">Eliminar</a></td>
            <td><a href="?action=ver&id=<?php echo $current['facturaid']; ?> ">ver</a></td>
            </tr> 
            <?php endforeach ?>
        </table>
        <a href="?action=registrar">Nueva factura.</a>
    </form>
    ...
    <?php
        ...
        echo '<form  action="FacturaVenta.php" method="Post">';
        ...
        case 'eliminar':
            ...
            $facturaBusiness->eliminarFactura($_REQUEST['id']);

            header('Location: FacturaVenta.php');
