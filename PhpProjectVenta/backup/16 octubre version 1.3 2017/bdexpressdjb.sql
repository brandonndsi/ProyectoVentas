...
CREATE TABLE `tbproveedores` (
  ...
  `materiaprimaid` int(11) NOT NULL,
  `proveedorproductos` text NOT NULL,
  `proveedorultimacompra` double NOT NULL,
...
INSERT INTO `tbproveedores` (`proveedorid`, `personaid`, `materiaprimaid`, `proveedorproductos`, `proveedorultimacompra`, `proveedorestado`) VALUES
(1, 6, 2, 'M1,M2', 25000, 1),
(2, 19, 3, 'M1', 15000, 1);
